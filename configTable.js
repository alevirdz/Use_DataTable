...
const buttonControlsPublic = `<button type="button" class="btn-primary id="lanuchModal">Guardar</button> | <button type="button" class="btn-primary Editar">Editar</button> | <button type="button" class="btn-primary eliminar" id="btn_delete">Eliminar</button>`
const buttonControlsAdmin = `<button type="button" class="btn-primary id="lanuchModal">Guardar</button> | <button type="button" class="btn-primary Editar">Editar</button> | <button type="button" class="btn-primary eliminar" id="btn_delete">Eliminar</button>`